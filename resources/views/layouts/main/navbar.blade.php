...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('AdminAssets/plugins/sweetalerts/sweetalert2.min.css') }}">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                        <li class="active">
                            <a href="{{ route('admin.vendor.create') }}"> Create </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.vendor.index') }}"> Show </a>
                        </li>
                    </ul>
                </li>
